...
float_color_map = {0: [0/255,63/255,92/255], 1: [188/255,80/255,144/255], 2: [255/255,166/255,0/255]}
    ...
    html.Div([
        ...
        html.Div([
            dash_table.DataTable(
                ...
                page_size=20,
                columns=[
                    {"name": i, "id": i} if i != 'clean_description'
                    else {"name": i, "id": i, 'presentation': 'markdown'}
...
def update_components(active_cell, page_current, page_size):
    ...
    projection_fig.add_trace(
        go.Scatter(
            ...
            mode='markers',
            marker={'color': movie_colors[0],
                    'size':10, 'line':{'width':1.5}},
            )
        )
